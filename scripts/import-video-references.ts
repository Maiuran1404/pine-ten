...
const VIDEO_REFERENCES = [
  ...
  },
  {
    ...
    tags: ['fast-paced', 'motion-graphics', 'tech', 'saas', 'explainer', 'dynamic'],
    styleAxis: 'tech',
  },
  {
    ...
    tags: ['cinematic', 'brand-story', 'premium', 'motion-graphics', 'inspirational'],
    styleAxis: 'premium',
  },
  {
    ...
    tags: ['brand-story', 'motion-graphics', 'inspirational', 'corporate', 'announcement'],
    styleAxis: 'corporate',
  },
  {
  ...
  },
  {
    ...
    tags: ['saas', 'explainer', 'motion-graphics', 'professional', 'startup', 'product-showcase'],
    styleAxis: 'minimal',
  },
  {
    ...
    tags: ['cinematic', 'motion-graphics', 'dynamic', 'inspirational', 'brand-story'],
    styleAxis: 'bold',
  },
  {
    ...
    tags: ['cinematic', 'brand-story', 'emotional', 'inspirational', 'premium', 'documentary'],
    styleAxis: 'premium',
  },
  {
...
async function importVideos() {
  console.log('╔════════════════════════════════════════════════════════════════╗')
  console.log('║       LAUNCH VIDEO REFERENCES IMPORT                           ║')
  console.log('╚════════════════════════════════════════════════════════════════╝\n')
  ...
  for (const video of VIDEO_REFERENCES) {
    ...
    try {
      ...
      console.log(
        `❌ Failed: ${video.name} - ${error instanceof Error ? error.message : 'Unknown error'}`
      )
      failed++
    }
  }
  ...
  console.log(`📊 Total launch video references in database: ${allVideos.length}`)
}
