...
async function seed() {
  ...
  const { taskCategories, styleReferences, platformSettings, users, securityTests } =
    await import('../src/db/schema')
  const { defaultTaskCategories } = await import('../src/lib/config')
  ...
  const styleData = [
    // Minimalist
    {
      ...
      imageUrl: 'https://images.unsplash.com/photo-1494438639946-1ebd1d20bf85?w=400&h=225&fit=crop',
      tags: ['minimalist', 'clean', 'white'],
    },
    {
      category: 'Minimalist',
      name: 'Simple Lines',
      imageUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=225&fit=crop',
      tags: ['minimalist', 'simple', 'lines'],
    },
    {
      category: 'Minimalist',
      name: 'Neutral Tones',
      imageUrl: 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=400&h=225&fit=crop',
      tags: ['minimalist', 'neutral', 'calm'],
    },
    // Bold & Colorful
    {
      category: 'Bold & Colorful',
      name: 'Vibrant Gradients',
      imageUrl: 'https://images.unsplash.com/photo-1557682250-33bd709cbe85?w=400&h=225&fit=crop',
      tags: ['bold', 'gradient', 'vibrant'],
    },
    {
      category: 'Bold & Colorful',
      name: 'Neon Pop',
      imageUrl: 'https://images.unsplash.com/photo-1550684376-efcbd6e3f031?w=400&h=225&fit=crop',
      tags: ['bold', 'neon', 'pop'],
    },
    {
      category: 'Bold & Colorful',
      name: 'Color Splash',
      imageUrl: 'https://images.unsplash.com/photo-1541701494587-cb58502866ab?w=400&h=225&fit=crop',
      tags: ['bold', 'colorful', 'splash'],
    },
    ...
    },
    {
      ...
      imageUrl: 'https://images.unsplash.com/photo-1497215842964-222b430dc094?w=400&h=225&fit=crop',
      tags: ['corporate', 'business', 'modern'],
    },
    {
      category: 'Corporate & Professional',
      name: 'Office Clean',
      imageUrl: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=400&h=225&fit=crop',
      tags: ['corporate', 'office', 'clean'],
    },
    // Playful & Fun
    {
      category: 'Playful & Fun',
      name: 'Bright & Happy',
      imageUrl: 'https://images.unsplash.com/photo-1513151233558-d860c5398176?w=400&h=225&fit=crop',
      tags: ['playful', 'fun', 'bright'],
    },
    {
      category: 'Playful & Fun',
      name: 'Colorful Confetti',
      imageUrl: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=400&h=225&fit=crop',
      tags: ['playful', 'confetti', 'party'],
    },
    {
      category: 'Playful & Fun',
      name: 'Cartoon Style',
      imageUrl: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=225&fit=crop',
      tags: ['playful', 'fun', 'creative'],
    },
    // Elegant & Luxury
    {
      category: 'Elegant & Luxury',
      name: 'Gold Accents',
      imageUrl: 'https://images.unsplash.com/photo-1560185127-6ed189bf02f4?w=400&h=225&fit=crop',
      tags: ['elegant', 'luxury', 'gold'],
    },
    {
      category: 'Elegant & Luxury',
      name: 'Dark Sophistication',
      imageUrl: 'https://images.unsplash.com/photo-1519608487953-e999c86e7455?w=400&h=225&fit=crop',
    ...
    },
    {
      ...
      name: 'Marble Premium',
      imageUrl: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=225&fit=crop',
      tags: ['elegant', 'marble', 'premium'],
    },
    // Modern & Clean
    {
      category: 'Modern & Clean',
      name: 'Geometric Modern',
      imageUrl: 'https://images.unsplash.com/photo-1557683316-973673baf926?w=400&h=225&fit=crop',
      tags: ['modern', 'geometric', 'clean'],
    },
    {
      category: 'Modern & Clean',
      name: 'Sleek Design',
      imageUrl: 'https://images.unsplash.com/photo-1545239351-ef35f43d514b?w=400&h=225&fit=crop',
      tags: ['modern', 'sleek', 'contemporary'],
    },
    {
      category: 'Modern & Clean',
      name: 'Fresh Layout',
      imageUrl: 'https://images.unsplash.com/photo-1493723843671-1d655e66ac1c?w=400&h=225&fit=crop',
      tags: ['modern', 'fresh', 'layout'],
    },
    // Retro & Vintage
    {
      category: 'Retro & Vintage',
      name: '70s Vibes',
      imageUrl: 'https://images.unsplash.com/photo-1558051815-0f18e64e6280?w=400&h=225&fit=crop',
      tags: ['retro', 'vintage', '70s'],
    },
    {
      category: 'Retro & Vintage',
      name: 'Film Grain',
      imageUrl: 'https://images.unsplash.com/photo-1518832553480-cd0e625ed3e6?w=400&h=225&fit=crop',
      tags: ['retro', 'film', 'nostalgic'],
    },
    {
      category: 'Retro & Vintage',
      name: 'Classic Poster',
      imageUrl: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=400&h=225&fit=crop',
      tags: ['retro', 'classic', 'poster'],
    },
    // Tech & Futuristic
    {
      ...
      tags: ['tech', 'cyber', 'neon'],
    },
    {
      category: 'Tech & Futuristic',
      name: 'Digital Grid',
      imageUrl: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=400&h=225&fit=crop',
    ...
    },
    {
      ...
      tags: ['tech', 'ai', 'abstract'],
    },
  ]

  for (const style of styleData) {
    await db.insert(styleReferences).values(style).onConflictDoNothing()
  }
  ...
  const securityTestData = [
    ...
    // Input Validation & XSS Tests
    {
      ...
      exploratoryConfig: {
        startUrl: '/',
        patterns: ['input fields', 'text areas', 'search boxes'],
        checkTypes: ['forms'],
      },
    ...
    },
    {
      ...
      exploratoryConfig: {
        startUrl: '/',
        patterns: ['search', 'filters', 'ID parameters'],
        checkTypes: ['forms'],
      },
    ...
    },
    {
      ...
      exploratoryConfig: {
        startUrl: '/',
        patterns: ['redirect parameters', 'return URLs', 'callback URLs'],
        checkTypes: ['links'],
      },
    ...
    },
    {
      ...
      exploratoryConfig: {
        startUrl: '/',
        patterns: ['file parameters', 'path parameters'],
        checkTypes: ['links'],
      },
  ...
  for (const test of securityTestData) {
    await db.insert(securityTests).values(test).onConflictDoNothing()
  }
  ...
  if (!adminEmail || !adminPassword) {
    ...
    if (existingAdmin.length > 0) {
      ...
      try {
        ...
        console.log(
          "2. Update role in database: UPDATE users SET role = 'ADMIN' WHERE email = '" +
            adminEmail +
            "';"
        )
      }
