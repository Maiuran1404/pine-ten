  ...
  return (
    <div className="flex items-center justify-between w-full">
      {workflowSteps.map((step, index) => {
        ...
        const isCurrent =
          currentStatus === step.status || (isRevision && step.status === 'IN_PROGRESS')
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Upload your completed deliverables when ready
              </p>
            </div>
          </div>
              ...
              {clientAttachments.length > 0 ? (
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Files provided by the client for reference</CardDescription>
                  </CardHeader>
                  <CardContent>
                    ...
                    {uploadedFiles.length > 0 && (
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        {uploadedFiles.map((file) => (
                          <div key={file.fileUrl} className="relative group border rounded-lg p-2">
                            {isImage(file.fileType) ? (
                              <Image
                                src={file.fileUrl}
                                alt={file.fileName}
                    ...
                    >
                      ...
                      <div>
                        ...
                        >
                          ...
                          ,{' '}
                          {artistDeadline.toLocaleTimeString(undefined, {
                            hour: '2-digit',
                            minute: '2-digit',
                          })}
                        </p>
