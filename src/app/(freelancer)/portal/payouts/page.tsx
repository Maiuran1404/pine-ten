      ...
      <div className="max-w-6xl mx-auto px-6 py-4 space-y-6">
          ...
          <Card className="border-amber-200 bg-amber-50/50 dark:border-amber-800 dark:bg-amber-950/20">
            <CardContent className="p-4">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <Button
                  onClick={
                    !stripeConnectStatus?.connected ? handleConnectStripe : handleContinueOnboarding
                  }
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-baseline gap-2">
                <span className="text-3xl sm:text-4xl font-bold">{stats?.pendingBalance || 0}</span>
                <span className="text-muted-foreground">credits</span>
              </div>
              <p className="text-sm text-muted-foreground mt-1">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <p className="text-xs text-muted-foreground mt-2 flex items-center gap-1 cursor-help">
                      ...
                      {stats?.pendingTasksCount || 0} tasks in review +{' '}
                      {payoutConfig?.holdingPeriodDays || 7}-day hold
                    </p>
                  </TooltipTrigger>
                  <TooltipContent>
                    <p>
                      Credits become available {payoutConfig?.holdingPeriodDays || 7} days after
                      task completion
                    </p>
                  </TooltipContent>
                </Tooltip>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-baseline gap-2">
                <span className="text-3xl sm:text-4xl font-bold">{stats?.totalPaidOut || 0}</span>
                <span className="text-muted-foreground">credits</span>
              </div>
              <p className="text-sm text-muted-foreground mt-1">
          ...
          <CardContent>
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="p-4 rounded-lg bg-muted/50">
                ...
                {stats?.thisMonthEarnings !== undefined &&
                  stats?.lastMonthEarnings !== undefined &&
          ...
          <TabsContent value="earnings" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Credits earned from completed tasks</CardDescription>
              </CardHeader>
              <CardContent>
                {earnings.length === 0 ? (
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-medium">
                              {payout.amount} credits → ${payout.netAmountUsd.toFixed(2)}
                            </p>
                            <p className="text-sm text-muted-foreground">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Download your tax documents for reporting</CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <DialogContent>
            ...
            <DialogFooter>
              ...
              <Button
                ...
                disabled={
                  isRequestingPayout || !payoutAmount || parseInt(payoutAmount) < minimumPayout
                }
              >
                {isRequestingPayout ? (
                  <>
