...
const ERROR_MESSAGES: Record<string, { title: string; description: string; icon: React.ReactNode }> = {
  state_mismatch: {
    title: "Session Conflict Detected",
    description: "It looks like you may already be signed into a different portal (client or artist) with this Google account. Please sign out of any other sessions and try again.",
    icon: <UserX className="w-12 h-12 text-amber-500" />,
  },
  oauth_code_verification_failed: {
    title: "Sign-in Session Expired",
    description: "Your sign-in session expired or there was a conflict with another login. This can happen if you're signed into multiple portals. Please try signing in again.",
    icon: <RefreshCw className="w-12 h-12 text-amber-500" />,
  },
  oAuth_code_missing: {
    title: "Sign-in Interrupted",
    description: "The sign-in process was interrupted. This can happen if you cancelled the sign-in or if there was a browser issue. Please try again.",
    icon: <AlertCircle className="w-12 h-12 text-amber-500" />,
  },
  default: {
    title: "Something went wrong",
    description: "We encountered an unexpected error during sign-in. Please try again or contact support if the issue persists.",
