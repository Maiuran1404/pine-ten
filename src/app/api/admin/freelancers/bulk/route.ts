        ...
        try {
          if (action === 'approve') {
            ...
            await notify({
              ...
              content:
                'Congratulations! Your freelancer application has been approved. You can now start accepting tasks.',
          ...
          logger.error(
            { err: error, freelancerId: profile.id },
            'Failed to send notification for bulk action'
          )
          results.failed.push({
            id: profile.id,
