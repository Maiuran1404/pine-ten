...
export function PositioningTab({ brand, updateField }: PositioningTabProps) {
  ...
  return (
    <div className="space-y-6">
      <SectionCard title="Value Proposition" description="What makes your brand uniquely valuable">
      ...
      <SectionCard title="Market Position" description="How you stand out from the competition">
        <div className="space-y-4">
          <div className="space-y-2">
