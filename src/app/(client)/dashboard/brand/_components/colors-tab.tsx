...
export function ColorsTab({
  ...
  return (
    <div className="space-y-6">
      <SectionCard title="Brand Colors" description="Primary palette for your brand identity">
      ...
      <SectionCard title="Background & Text" description="Base colors for layouts and readability">
      ...
      <SectionCard title="Additional Palette" description="Extra colors used across your brand">
