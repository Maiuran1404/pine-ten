...
export function SocialTab({ brand, updateField }: SocialTabProps) {
  return (
    <div className="space-y-6">
      <SectionCard title="Contact Information" description="How clients and partners can reach you">
      ...
      <SectionCard title="Social Media" description="Your brand's presence across platforms">
