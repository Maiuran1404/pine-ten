...
export function AudiencesTab({ audiences, onDelete, onSetPrimary }: AudiencesTabProps) {
  ...
  if (audiences.length === 0) {
    return (
      <SectionCard title="Target Audiences" description="People and businesses your brand serves">
        <div className="text-center py-8 px-6 rounded-xl border border-dashed border-border">
          ...
          <p className="text-muted-foreground text-sm max-w-sm mx-auto">
            ...
            Use the overflow menu to redo onboarding and scan your website.
          </p>
        </div>
      </SectionCard>
    )
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            This will permanently remove &quot;{audience.name}&quot; from your
                            target audiences. This action cannot be undone.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
