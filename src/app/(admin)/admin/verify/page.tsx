          ...
          <Card className="border-dashed">
            <CardContent className="py-16 text-center">
              ...
              <p className="text-muted-foreground max-w-md mx-auto">
                There are no deliverables waiting for review. Check back later for new submissions
                from artists.
              </p>
            </CardContent>
          </Card>
                ...
                {tasks.map((task, index) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      {index === 0 && <div className="w-1 h-12 bg-primary rounded-full" />}
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="flex items-center gap-2 text-sm text-muted-foreground mt-0.5">
                          <span className="truncate">
                            by {task.freelancer?.name || 'Unknown Artist'}
                          </span>
                          <span className="text-muted-foreground/50">→</span>
                          <span className="truncate">
                            for {task.client?.name || 'Unknown Client'}
                          </span>
                        </div>
