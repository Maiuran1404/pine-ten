    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">View all database tables and records</p>
        </div>
        <Button
          variant="outline"
          onClick={() => {
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{selectedTable || 'None'}</div>
          </CardContent>
        </Card>
      </div>
              ...
              <>
                ...
                <div className="flex items-center justify-between mt-4">
                  <p className="text-sm text-muted-foreground">
                    Showing {page * limit + 1} - {Math.min((page + 1) * limit, tableData.total)} of{' '}
                    {tableData.total}
                  </p>
