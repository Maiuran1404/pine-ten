...
async function migrate() {
  ...
  try {
    ...
    try {
      await db.execute(sql`CREATE INDEX "ssh_user_style_idx" ON "style_selection_history" ("user_id", "style_axis")`);
    ...
    try {
      await db.execute(sql`CREATE INDEX "ssh_user_type_idx" ON "style_selection_history" ("user_id", "deliverable_type")`);
