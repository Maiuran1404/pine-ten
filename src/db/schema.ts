...
export const generatedDesigns = pgTable(
  'generated_designs',
  {
    ...
    modificationsUsed: jsonb('modifications_used').$type<Record<string, unknown>>(), // Store what values were used
...
export const orshotTemplatesRelations = relations(orshotTemplates, ({ many }) => ({
  generatedDesigns: many(generatedDesigns),
}))

// Generated designs relations
export const generatedDesignsRelations = relations(generatedDesigns, ({ one }) => ({
  client: one(users, {
