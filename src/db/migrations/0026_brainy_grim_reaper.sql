...
CREATE INDEX "early_access_waitlist_status_idx" ON "early_access_waitlist" USING btree ("status");--> statement-breakpoint
CREATE INDEX "tasks_client_created_at_idx" ON "tasks" USING btree ("client_id","created_at");--> statement-breakpoint
CREATE INDEX "tasks_status_created_at_idx" ON "tasks" USING btree ("status","created_at");--> statement-breakpoint
CREATE INDEX "tasks_freelancer_status_idx" ON "tasks" USING btree ("freelancer_id","status");--> statement-breakpoint
CREATE INDEX "tasks_category_status_idx" ON "tasks" USING btree ("category_id","status");