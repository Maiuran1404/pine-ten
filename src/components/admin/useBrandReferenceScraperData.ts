...
export function useBrandReferenceScraperData({ onUploadComplete }: UseBrandReferenceScraperDataOptions = {}) {
  ...
  const scrapeSinglePage = useCallback(async (url: string): Promise<ScrapedImage[]> => {
