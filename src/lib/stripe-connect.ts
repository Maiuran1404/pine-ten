 ...
 */
export async function getOnboardingLink(stripeAccountId: string): Promise<string> {
  const stripe = getStripe()
  const artistUrl = getArtistPortalUrl()
 ...
 */
export async function getDashboardLink(stripeAccountId: string): Promise<string> {
  const stripe = getStripe()
 ...
 */
export async function syncConnectAccountStatus(stripeAccountId: string): Promise<{
