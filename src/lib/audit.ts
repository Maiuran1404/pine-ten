 ...
 */
export function actorFromUser(user: { id: string; email: string; role?: string }): AuditActor {
  return {
    id: user.id,
    email: user.email,
...
export const auditHelpers = {
  ...
  databaseAccess: (actor: AuditActor, tableName: string, endpoint: string) =>
    audit({
      actor,
  ...
  /** Log coupon creation */
  couponCreate: (actor: AuditActor, couponId: string, couponName: string, endpoint: string) =>
    audit({
      actor,
  ...
  /** Log coupon deletion */
  couponDelete: (actor: AuditActor, couponId: string, endpoint: string) =>
    audit({
      actor,
  ...
  /** Log login attempt */
  loginAttempt: (userId: string | null, email: string, success: boolean, errorMessage?: string) =>
    audit({
  ...
  /** Log task creation */
  taskCreate: (actor: AuditActor, taskId: string, taskTitle: string, endpoint: string) =>
    audit({
      actor,
      action: 'TASK_CREATE',
      resourceType: 'task',
  ...
  /** Log credit purchase */
  creditPurchase: (actor: AuditActor, amount: number, stripePaymentId: string, endpoint: string) =>
    audit({
      actor,
  ...
  securityTestRun: (actor: AuditActor, runId: string, testCount: number, endpoint: string) =>
    audit({
      actor,
